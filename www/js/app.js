      ...
      success: function(data, status, xhr) {
        ...
        for (var i = 0; i < gyms.length; i++) {
          ...
          gymsList +=
            ...
            gyms[i].work_time +
            "</td>" +
            '<td class="label-cell" onclick="openMap(' +
            lat +
            "," +
            long +
            ')"><a>coordinates</a></td>' +
            ...
            gyms[i].password +
            "</td>" +
            '<td class="numeric-cell"><a data-id="' +
            gyms[i].id +
            '" onclick="deleteGym(this)" class="button">' +
            '<i class="icon f7-icons green-color">trash_circle_fill</i></a>' +
            '<a data-id="' +
            gyms[i].id +
            '" onclick="updateGym(this)" class="button">' +
    ...
    success: function(data, status, xhr) {
      ...
      for (var i = 0; i < users.length; i++) {
        usersList +=
          ...
          '<td class="numeric-cell"><a data-id="' +
          users[i].id +
          '" onclick="updateAdmin(this)" class="button">' +
          '<i class="icon f7-icons green-color">square_pencil</i>' +
          "</a>" +
          '<a data-id="' +
          users[i].id +
          '" onclick="deleteAdmin(this)" class="button">' +
          '<i class="icon f7-icons green-color">trash_circle_fill</i></a>' +
          "</td>" +
          "</tr>";
      }
